...
description: "The ReplyToItem element contains a reply to the sender of an item in the Exchange store."
---
...
|[ToRecipients](torecipients.md) <br/> |Contains an array of recipients of an item. These are the primary recipients of an item.  <br/> |
