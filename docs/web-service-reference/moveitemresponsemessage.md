...
|:-----|:-----|
|**ResponseClass** <br/> | Describes the status of a [MoveItem operation](moveitem-operation.md) response. The following values are valid for this attribute:  <br/>  Success  <br/>  Warning  <br/>  Error  <br/> |
