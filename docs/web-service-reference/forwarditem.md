...
description: "The ForwardItem element contains an Exchange store item to forward to recipients."
---
...
The [From](from.md) element should be set to the e-mail address of the principal if an item is forwarded by a delegate. If the delegate does not set the [From](from.md) property, the item will appear to have been sent directly from the delegate's mailbox. 
