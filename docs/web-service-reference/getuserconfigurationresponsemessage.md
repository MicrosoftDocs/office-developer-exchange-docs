...
description: "The GetUserConfigurationResponseMessage element represents a response that returns a user configuration object."
---
...
|[UserConfiguration](userconfiguration.md) <br/> |Contains a single user configuration object.  <br/> |
