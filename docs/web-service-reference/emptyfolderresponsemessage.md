...
|:-----|:-----|
|**ResponseClass** <br/> | Describes the status of an [EmptyFolder operation](emptyfolder-operation.md) response. The following values are valid for this attribute:  <br/>  Success  <br/>  Warning  <br/>  Error  <br/> |
