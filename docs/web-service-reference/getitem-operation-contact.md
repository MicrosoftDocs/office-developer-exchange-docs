...
description: "The GetItem operation is used to get contact items from the Exchange store."
---
...
The following code example shows a successful GetItem response for the **AllProperties**[BaseShape](baseshape.md).
