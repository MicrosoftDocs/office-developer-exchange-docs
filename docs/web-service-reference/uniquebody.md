...
description: "The UniqueBody element represents an HTML fragment or plain text which represents the unique body of this conversation."
---
...
|:-----|:-----|
|**BodyType** <br/> |Describes how the item body is stored in the item.  <br/> |
