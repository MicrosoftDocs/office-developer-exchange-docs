...
description: "The CreateUserConfigurationResponseMessage element contains the status and result of a single CreateUserConfiguration request."
---
...
|**Error** <br/> | Describes a request that cannot be fulfilled.<br/><br/> The following are examples of sources of errors:  <br/><br/>- Invalid attributes or elements.  <br/>- Attributes or elements that are out of range.  <br/>- An unknown tag.  <br/>- The attribute or element is not valid in the context.  <br/>- An unauthorized access attempt by any client.  <br/>- A server-side failure in response to a valid client-side call.<br/><br/>  Information about the error can be found in the [ResponseCode](responsecode.md) and [MessageText](messagetext.md) elements.  <br/> |
