...
The **LocationUrl** element represents the URL of a document sharing location. 
...
The text value of the **LocationUrl** element is the URL of a document sharing location. 
