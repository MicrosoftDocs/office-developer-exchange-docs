...
description: "The GlobalMessageCount element contains the total number of conversation items in the mailbox."
---
...
The text value of the **GlobalMessageCount** element is the total number of conversation items in a mailbox. 
