...
|:-----|:-----|
|**ResponseClass** <br/> | Describes the status of a **SendNotification** operation response. The following values are valid for this attribute:  <br/>  Success  <br/>  Warning  <br/>  Error  <br/> |
