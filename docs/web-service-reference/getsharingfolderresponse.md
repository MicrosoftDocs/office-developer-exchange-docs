...
description: "The GetSharingFolderResponse element defines a response to a GetSharingFolder operation request."
---

# GetSharingFolderResponse

The **GetSharingFolderResponse** element defines a response to a [GetSharingFolder operation](getsharingfolder-operation.md) request. 
