...
|[ContainsHeaderStrings](containsheaderstrings.md) <br/> |Indicates the strings that must appear in the headers of incoming messages in order for the condition or exception to apply.  <br/> |
