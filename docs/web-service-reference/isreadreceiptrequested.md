...
description: "The IsReadReceiptRequested element indicates whether the sender of an item requests a read receipt."
---
...
|[CancelCalendarItem](cancelcalendaritem.md) <br/> |Represents the response object thatis used to cancel a meeting.  <br/> |
...
If **IsReadReceiptRequested** is **true**, setting [IsRead](isread.md) to **true** sends a read receipt. The recipient can suppress read receipts by submitting the [SuppressReadReceipt](suppressreadreceipt.md) response object before setting the **IsRead** property. 
