...
|:-----|:-----|
|**ResponseClass** <br/> | Describes the status of a [GetFolder operation](getfolder-operation.md) response. The following values are valid for this attribute:  <br/>  Success  <br/>  Warning  <br/>  Error  <br/> |
