...
description: "The GetMailTips element represents the recipients and types of mail tips to retrieve."
---
...
|**Element**|**Description**|
|:-----|:-----|
|[SendingAs](sendingas.md) <br/> |Contains an e-mail address that a user is trying to send as.  <br/> |
