...
description: "The CustomMailTip element represents a customized mail tip message."
---
...
|**Element**|**Description**|
|:-----|:-----|
|[MailTips](mailtips.md) <br/> |Represents values for the various types of mail tips.  <br/> |
