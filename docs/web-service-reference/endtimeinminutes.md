...
description: "The EndTimeInMinutes element represents the end of the working day for a mailbox user."
---
...
A text value is required. The text value represents the end of the working day by how many minutes have elapsed since the day began. For example, an end time of 6 P.M. is represented by 1080 minutes.
