...
description: "The IsAssociated element indicates whether the item is associated with a folder."
---
...
A text value of **true** indicates that the item is associated with a folder; a value of **false** indicates that the item is not associated with a folder. 
