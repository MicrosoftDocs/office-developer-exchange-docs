...
description: "The IsTeamTask element indicates whether the task is owned by a team."
---
...
The text value represents a Boolean value that indicates whether a task is owned by a team. This is a read-only property.
