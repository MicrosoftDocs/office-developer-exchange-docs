...
description: "The CreateItem operation is used to accept an invitation to share another user's calendar or contacts data."
---
...
The following example shows an error response to a **CreateItem** request. The error is caused by an attempt to accept a sharing invitation that cannot be found in the Exchange store. 
