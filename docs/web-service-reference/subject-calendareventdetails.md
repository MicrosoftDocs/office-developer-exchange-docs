...
description: "The Subject element represents the subject of a calendar item."
---
...
A text value is required if this element is returned in the response. This element will not be returned if the [IsPrivate](isprivate.md) element value is equal to **true**. This element can contain an empty string. This element is optional if the [CalendarEventDetails](calendareventdetails.md) element is used. 
