...
|CDOWF  <br/> |No  <br/> |[Windows Workflow Foundation (WWF)](http://msdn.microsoft.com/library/vstudio/ms735967%28v=vs.90%29.aspx) <br/> |You can use WWF to create advanced workflow applications that work with Exchange 2007.   <br/> |
